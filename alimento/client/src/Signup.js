...
import { AiFillFacebook,AiOutlineInstagram,AiFillGithub,AiFillRedditCircle,AiOutlineMail,AiFillLinkedin,AiOutlineWhatsApp,AiFillTwitterCircle,AiFillYoutube,AiFillMessage } from 'react-icons/ai';
...
<div>  <div className="InputContainer">
      ...
      <ReCAPTCHA sitekey="6LccN0UoAAAAAFgwzHb0TeY0-E1VinrJf1Ex23mL" className='g-recaptcha'/>

      <button id="button" type='submit' >Submit</button>
     
      <div className="signupContainer">
        <p>Don't have any account?</p>
       <a><Link to="/login">Sign up</Link> </a>
