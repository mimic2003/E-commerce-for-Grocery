...
function Donation() {
  ...
  const handlesubmit= async (e)=>{
    ...
    e.preventDefault();
    var a=parseInt(totalDonation) + parseInt(donationAmount)
    setTotalDonation(a);
  const val={
  donation:donationAmount,
  totalDonation:parseInt(totalDonation)+parseInt(donationAmount),
  name:name,
  cardnumber:number,
  date:date,
  cvv:cvv
  ...
  const data= await axios.post("http://localhost:5000/dbcard",val)
  alert("Card details save succesfully");
  setDonationAmount(0)
  setName("");
  setnumber("");
  setDate("");
  ...
  const amountzero=()=>{
    ...
    const timeline = gsap. timeline({
        ...
        const DATA = [
        {id: 1, year: "", name: 'Fresh', ref: e1Ref},{id: 2, year: "", name: 'Fast', ref: e2Ref}, {id: 3, year: "", name: 'Convenient', ref: e3Ref},
        ]
    useEffect(() => {
        timeline
        ...
        <ul className="list">
          <li className="slide">
            <div
              ...
              style={{ backgroundImage: "url('https://images.unsplash.com/photo-1527090820885-efdd40ab2657?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')" }}
            ></div>
            <div className="content">
        <span>Empower Change Through Giving</span>
          ...
          <li className="slide">
            <div
              className="background"
              style={{ backgroundImage: "url('https://images.unsplash.com/photo-1542810634-71277d95dcbb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')" }}
            ></div>
            <div className="content">
          ...
          <li className="slide">
            <div
              className="background"
              style={{ backgroundImage: "url('https://images.unsplash.com/photo-1595561579181-263fe6175b73?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')" }}
            ></div>
...
<br></br>
Supporting Hope, One Donation at a Time
          ...
          <li className="slide">
            <div
              className="background"
              style={{ backgroundImage: "url('https://images.unsplash.com/photo-1518949142393-f1d68174c92a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1887&q=80')" }}
            ></div>
            <div className="content">
            Be the Heart Behind our Mission: Donate Today
            </div>
          </li>
          <li className="slide">
            <div
              className="background"
              style={{ backgroundImage: "url('https://images.unsplash.com/photo-1610348304377-cdbe9c0b68a4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1918&q=80')" }}
            ></div>
            <div className="content">
                
            Join Hands, Give Back, Transform Lives
            </div>
          </li>
        </ul>
      </section>
...
<strong>{totalDonation}</strong>
  ...
  >
    ...
    ></path>
      ...
      >
        <path
          d="M93.6,27.1C87.6,34.2,78,39.8,68.4,39c-1.2-9.6,3.5-19.8,9-26.1c6-7.3,16.5-12.5,25-12.9  C103.4,10,99.5,19.8,93.6,27.1 M102.3,40.9c-13.9-0.8-25.8,7.9-32.4,7.9c-6.7,0-16.8-7.5-27.8-7.3c-14.3,0.2-27.6,8.3-34.9,21.2  c-15,25.8-3.9,64,10.6,85c7.1,10.4,15.6,21.8,26.8,21.4c10.6-0.4,14.8-6.9,27.6-6.9c12.9,0,16.6,6.9,27.8,6.7  c11.6-0.2,18.9-10.4,26-20.8c8.1-11.8,11.4-23.3,11.6-23.9c-0.2-0.2-22.4-8.7-22.6-34.3c-0.2-21.4,17.5-31.6,18.3-32.2  C123.3,42.9,107.7,41.3,102.3,40.9 M182.6,11.9v155.9h24.2v-53.3h33.5c30.6,0,52.1-21,52.1-51.4c0-30.4-21.1-51.2-51.3-51.2H182.6z   M206.8,32.3h27.9c21,0,33,11.2,33,30.9c0,19.7-12,31-33.1,31h-27.8V32.3z M336.6,169c15.2,0,29.3-7.7,35.7-19.9h0.5v18.7h22.4V90.2  c0-22.5-18-37-45.7-37c-25.7,0-44.7,14.7-45.4,34.9h21.8c1.8-9.6,10.7-15.9,22.9-15.9c14.8,0,23.1,6.9,23.1,19.6v8.6l-30.2,1.8  c-28.1,1.7-43.3,13.2-43.3,33.2C298.4,155.6,314.1,169,336.6,169z M343.1,150.5c-12.9,0-21.1-6.2-21.1-15.7c0-9.8,7.9-15.5,23-16.4  c26.9-1.7,26.9-1.7,26.9-1.7v8.8C371.9,140.1,359.5,150.5,343.1,150.5z M425.1,210.2c23.6,0,34.7-9,44.4-36.3L512,54.7h-24.6  l-28.5,92.1h-0.5l-28.5-92.1h-25.3l41,113.5l-2.2,6.9c-3.7,11.7-9.7,16.2-20.4,16.2c-1.9,0-5.6-0.2-7.1-0.4v18.7  C417.3,210,423.3,210.2,425.1,210.2z"
          id="XMLID_34_"
        ></path>
      </svg>
          </button>
      ...
      <defs>
        ...
        <div className="input_container">
            ...
            <input
              ...
              type="text"
              name="amount"
              placeholder="Enter the donating amount"
        ...
        <button className="purchase--btn" type="submit">Donate</button>
        <button className="purchase--btn" type="reset" onClick={amountzero}>Reset</button>
      </form>
